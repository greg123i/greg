...
class GregBrain(nn.Module):
    ...
    def init_state(self, batch_size, device):
        ...
        return {
            ...
            'hiddens': (interpreter_hidden, thinker_memory, central_hidden, thalamus_hidden)
        }
    ...
    def forward(self, 
        ...
        (h_interp, h_think, h_central, h_thal) = state['hiddens']
        ...
        new_cmd_reader, new_cmd_thinker, new_cmd_writer, shutdown_logits, new_h_thal = \
            self.thalamus(out_reader, out_thinker, out_writer, h_thal)
        ...
        next_state = {
            ...
            'hiddens': (new_h_interp, new_h_think, new_h_central, new_h_thal)
        }
